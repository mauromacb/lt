...
<html lang="en">
	<head>
		...
		<title>Administrador Web Latin Trails</title>
		...
		<div class="wrapper">
			<header class="main-header">
				...
				<a href="{{url('dashboard')}}" class="logo">
					...
					<span class="logo-lg"><b>Latin </b>Trails</span>
				</a>
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown notifications-menu">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									...
									<span class="label notification-label">nuevos</span>
								</a>
								<ul class="dropdown-menu">
									<li class="header">Sus notificaciones</li>
									<li>
			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li class="treeview"><a href="{{url('/users')}}"><i class="fa fa-users"></i> <span>Usuarios</span></a></li>
